...
const cards = [
  { Icon: Users, h1: "10k+", p: "Active Students", color: "text-blue-400" },
  { Icon: Trophy, h1: "95%", p: "Success Rate", color: "text-purple-400" },
  { Icon: Clock4, h1: "500h+", p: "Course Hours", color: "text-green-400" },
];
...
const HeroSection = () => {
  return (
    <>
      <div
        id="colorLayer"
        className="w-full h-full absolute top-20 right-0 blur-[6rem] md:blur-[12rem]"
      >
      ...
      <section className="relative z-20 flex flex-col w-full h-full gap-6 pb-10 overflow-hidden">
        <div
          id="spacing"
          className="z-30 flex items-center justify-between w-3/4 h-32 mx-auto"
        >
        ...
        <div className="flex flex-wrap justify-center w-4/5 gap-4 mx-auto mt-4 sm:gap-2 sm:w-fit md:gap-12">
          {cards.map((item, index) => (
            <span
              key={index}
              className="flex flex-col items-center justify-center gap-2 px-5 py-2 bg-white/10 rounded-xl sm:px-10 sm:py-6 sm:min-w-32 backdrop-blur-2xl"
            >
